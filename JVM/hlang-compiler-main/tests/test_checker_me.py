...
"""
    expected = "Type Mismatch In Expression: StringLiteral('index')"
    assert Checker(source).check_from_source() == expected
...
"""
    expected = "Type Mismatch In Expression: BooleanLiteral(False)"
    assert Checker(source).check_from_source() == expected
...
"""
    expected = "Type Mismatch In Expression: FloatLiteral(2.5)"
    assert Checker(source).check_from_source() == expected
...
"""
    expected = "Type Mismatch In Statement: ExprStmt(FunctionCall(Identifier(add), [IntegerLiteral(1), IntegerLiteral(2)]))"
    assert Checker(source).check_from_source() == expected
...
"""
    expected = "Type Mismatch In Expression: ArrayLiteral([Identifier(y), IntegerLiteral(2)])"
    assert Checker(source).check_from_source() == expected
...
"""
    expected = "Type Mismatch In Statement: VarDecl(x, FunctionCall(Identifier(doSomething), []))"
    assert Checker(source).check_from_source() == expected
...
"""
    expected = "Type Mismatch In Expression: ArrayLiteral([IntegerLiteral(1), BooleanLiteral(True), IntegerLiteral(3)])"
    assert Checker(source).check_from_source() == expected
...
'''
    expected = "Type Mismatch In Expression: StringLiteral('0')"
    assert Checker(source).check_from_source() == expected
